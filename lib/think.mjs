...
// max_tokens budgets reasoning AND the answer, not just the answer. Cap it
// at the length of the sentence you want and reasoning consumes the whole
// allowance, leaving an empty string. Brevity is enforced by the system
// prompt; this only has to leave the model room to think.
const BUDGET = { minimal: 400, low: 700, medium: 1200, high: 2000, xhigh: 4000 };
